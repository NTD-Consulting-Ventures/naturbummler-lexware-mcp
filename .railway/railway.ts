  ...
  return project('naturbummler-cargo-mcp', {
    resources: [service('naturbummler-lexware-mcp', {
      ...
      env: {
        ...
        ENTRA_CLIENT_ID: '${{cargo-mcp.ENTRA_CLIENT_ID}}',
        ENTRA_CLIENT_SECRET: '${{cargo-mcp.ENTRA_CLIENT_SECRET}}',
        ENTRA_API_AUDIENCE: '${{cargo-mcp.ENTRA_CLIENT_ID}}',
        ENTRA_SCOPE: '${{cargo-mcp.ENTRA_SCOPE}}',
        ENTRA_ACCESS_POLICY: 'tenant',
        MCP_PUBLIC_BASE_URL: 'https://naturbummler-lexware-mcp-production.up.railway.app',
        MCP_ALLOWED_REDIRECT_URIS: 'https://claude.ai/api/mcp/auth_callback',
        OAUTH_JWT_SIGNING_KEY: '${{cargo-mcp.OAUTH_JWT_SIGNING_KEY}}',
        OAUTH_STORAGE_ENCRYPTION_KEY: '${{cargo-mcp.OAUTH_STORAGE_ENCRYPTION_KEY}}',
        REDIS_URL: '${{cargo-mcp.REDIS_URL}}',
